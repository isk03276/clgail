...
class Jaco2PickUpEnv():
    ...
    def reset(self):
        ...
        self.episode_now = 0
        self.init_qpos[1] = 3.
        self.init_qpos[2] = 3.14
        self.init_qpos[3] = 1.0
        self.init_qpos[4] = 0.
        self.init_qpos[5] = 0.
        self.init_qpos[6] = -0.017
        self.init_qpos[7] = 0.0
        self.init_qpos[8] = 0.003
        self.init_qvel[0] = 0.
        self.init_qvel[1] = 0.
        self.init_qvel[2] = 0.
        self.init_qvel[3] = 0.
    ...
    def step(self, a):
        ...
        if hand_d < 0.1:
            ...
            if self.sim.data.get_body_xpos("target1")[2] > 0.06 and self.sim.data.get_body_xpos("target1")[2] < 0.2:
                reward += 0.3# + self.sim.data.get_body_xpos("target1")[2]
                #reward += (self.sim.data.get_body_xpos("target1")[2] - 0.03) * 3000
        
        if self.sim.data.get_body_xpos("target1")[2] > 0.3:
            reward += 1#0.6
