...
class Jaco2StackEnv():
    def __init__(self,
        ...
        model_path = "jaco_arm2_stack.xml"
    ...
    def reset(self):
        ...
        self.init_finger_g = (self.sim.data.get_body_xpos("j2n6s300_link_finger_1") + self.sim.data.get_body_xpos("j2n6s300_link_finger_2") + self.sim.data.get_body_xpos("j2n6s300_link_finger_3")) / 3
        self.old_finger_g = (self.sim.data.get_body_xpos("j2n6s300_link_finger_1") + self.sim.data.get_body_xpos("j2n6s300_link_finger_2") + self.sim.data.get_body_xpos("j2n6s300_link_finger_3")) / 3
    ...
    def get_target_randompos(self):
        ...
        while(True):
            pos_first = random()
            if pos_first > 0.4 and pos_first < 0.5:
                break
        while(True):
            pos_second = random() - 0.5
            if pos_second > -0.2 and pos_second < 0.2:
                break
        pos_third = 0.025
    ...
    def step(self, a):
        ...
        finger1_tip_position = [i/10 for i in self.first_finger_vector] + self.sim.data.get_body_xpos("j2n6s300_link_finger_1")
        finger2_tip_position = [i/10 for i in self.second_finger_vector] + self.sim.data.get_body_xpos("j2n6s300_link_finger_2")
        finger3_tip_position = [i/10 for i in self.third_finger_vector] + self.sim.data.get_body_xpos("j2n6s300_link_finger_3")
        ...
        if centerd < 0.1:
            ...
            if self.sim.data.get_body_xpos("target1")[2] > 0.04:
                reward += abs(self.sim.data.get_body_xpos("target1")[2] - 0.025) #pass#reward += self.sim.data.get_body_xpos("target1")[2] # + self.sim.data.get_body_xpos("target1")[2]
            ...
            distance_target1_ontarget2 = np.linalg.norm(self.sim.data.get_body_xpos("target1") - (self.sim.data.get_body_xpos("target2") + [0, 0, 0.025]))
