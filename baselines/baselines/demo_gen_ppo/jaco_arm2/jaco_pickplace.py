    ...
    def step(self, a):
        ...
        if hand_d < 0.10:
            ...
            if self.sim.data.get_body_xpos("target1")[2] > 0.06 and self.sim.data.get_body_xpos("target1")[2] < 0.2:
                reward += 0.3 + self.sim.data.get_body_xpos("target1")[2] + np.linalg.norm(self.sim.data.get_body_xpos("target1") - (self.sim.data.get_body_xpos("target2") + [0, 0, 0.036]))
        ...
        # z ~ 0.105
        # 3
        distance_target1_ontarget2 = np.linalg.norm(self.sim.data.get_body_xpos("target1") - (self.sim.data.get_body_xpos("target2") + [0, 0, 0.036]))
